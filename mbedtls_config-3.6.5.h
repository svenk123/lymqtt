 ...
 *  memory footprint.
 *
 *  This configuration is adapted from mbedTLS 2.16.1 configuration
 *  for use with mbedTLS 3.6.5. Key adaptations:
 *  - TLS 1.3 support enabled (MBEDTLS_SSL_PROTO_TLS1_3)
 *  - MBEDTLS_NET_C disabled (using send/recv directly over POSIX)
 *  - MBEDTLS_PSK_MAX_LEN set to 256 (from default 32)
 *  - MBEDTLS_SSL_IN_CONTENT_LEN and MBEDTLS_SSL_OUT_CONTENT_LEN set to 2048
 *    (reduced from default 16384 to save memory, matching old MBEDTLS_SSL_MAX_CONTENT_LEN)
 */

/* PSA Algorithm definitions for TLS 1.3
 * These are required for TLS 1.3 ephemeral key exchange even when
 * MBEDTLS_PSA_CRYPTO_CONFIG is disabled. They tell PSA which algorithms
 * are available through the mbedTLS API.
 * Note: When MBEDTLS_PSA_CRYPTO_CONFIG is disabled, PSA automatically
 * derives these from MBEDTLS_* symbols, but explicit definitions ensure
 * TLS 1.3 works correctly.
 */
...
#endif
/* PSA Key Type definitions for ECC (required for X25519/Curve25519) */
#ifndef PSA_WANT_KEY_TYPE_ECC_PUBLIC_KEY
#define PSA_WANT_KEY_TYPE_ECC_PUBLIC_KEY 1
#endif
#ifndef PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_BASIC
#define PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_BASIC 1
#endif
#ifndef PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_GENERATE
#define PSA_WANT_KEY_TYPE_ECC_KEY_PAIR_GENERATE 1
#endif
/* PSA ECC Curve definitions (for X25519/Curve25519) */
 ...
 */
//#define MBEDTLS_NET_C  /* Disabled: we use send/recv directly over POSIX */
 ...
 */
#define MBEDTLS_SSL_IN_CONTENT_LEN              16384  /* Reduced from default 16384 to save memory */
 ...
 */
#define MBEDTLS_SSL_OUT_CONTENT_LEN             2048  /* Reduced from default 16384 to save memory */
...
#define MBEDTLS_PSK_MAX_LEN               256 /**< Max size of TLS pre-shared keys, in bytes (default 256 or 384 bits) */
